...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__t_test__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__plot_options__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__plot_options__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_d3__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__plot_options__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__t_test__ = __webpack_require__(25);
...
var PlotComponent = (function () {
    ...
    PlotComponent.prototype.dragTarget = function (event) {
        ...
        var y = this.yScale.invert(__WEBPACK_IMPORTED_MODULE_1_d3__["event"].y - this.margin);
    ...
    PlotComponent.prototype.clipPath = function () {
        return "url(#" + this.clipPathId + ")";
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_switch__ = __webpack_require__(239);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__t_test__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__plot_options__ = __webpack_require__(24);
...
var AppComponent = (function () {
    function AppComponent(ttestService) {
        ...
        this.newModel = new __WEBPACK_IMPORTED_MODULE_4__t_test__["b" /* TTest */]();
        this.modelSets = [];
    ...
    AppComponent.prototype.ngOnInit = function () {
        var model = new __WEBPACK_IMPORTED_MODULE_4__t_test__["b" /* TTest */]({
    ...
    AppComponent.prototype.addModel = function (model, select) {
        ...
        this.ttestService.create(model).
            ...
            var model = new __WEBPACK_IMPORTED_MODULE_4__t_test__["b" /* TTest */](result.model);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__start_start_component__ = __webpack_require__(163);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__t_test_t_test_component__ = __webpack_require__(164);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__output_pane_output_pane_component__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__help_help_component__ = __webpack_require__(160);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__plot_options_plot_options_component__ = __webpack_require__(128);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__plot_plot_component__ = __webpack_require__(129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__bottom_plot_bottom_plot_component__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__environments_environment__ = __webpack_require__(58);
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_9__t_test_t_test_component__["a" /* TTestComponent */],
            __WEBPACK_IMPORTED_MODULE_10__output_pane_output_pane_component__["a" /* OutputPaneComponent */],
            __WEBPACK_IMPORTED_MODULE_11__help_help_component__["a" /* HelpComponent */],
            __WEBPACK_IMPORTED_MODULE_12__plot_options_plot_options_component__["a" /* PlotOptionsComponent */],
            __WEBPACK_IMPORTED_MODULE_13__plot_plot_component__["a" /* PlotComponent */],
            __WEBPACK_IMPORTED_MODULE_14__bottom_plot_bottom_plot_component__["a" /* BottomPlotComponent */]
        ],
        imports: [
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_7__t_test_service__["a" /* TTestService */], { provide: __WEBPACK_IMPORTED_MODULE_1__angular_common__["a" /* APP_BASE_HREF */], useValue: __WEBPACK_IMPORTED_MODULE_15__environments_environment__["a" /* environment */].baseHref }],
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__t_test__ = __webpack_require__(25);
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["p" /* Input */])(),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__t_test__["b" /* TTest */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__t_test__["b" /* TTest */]) === "function" && _a || Object)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_add_operator_debounceTime__ = __webpack_require__(238);
...
var TTestComponent = (function () {
    ...
    TTestComponent.prototype.ngOnInit = function () {
        ...
        this.model.onChange.
            ...
            if (keys.length > 1 || (keys[0] != "showAlternates" && keys[0] != _this.model.output)) {
                _this.updateModelSet();
                _this.round.roundUpdate(changes, false);
            }
        });
        this.round.onChange.subscribe(function (changes) {
            _this.model.update(changes);
        });
        this.min = new __WEBPACK_IMPORTED_MODULE_2__t_test__["b" /* TTest */](this.model);
        this.max = new __WEBPACK_IMPORTED_MODULE_2__t_test__["b" /* TTest */](this.model);
        this.min.alpha = 0.01;
        this.max.alpha = 0.99;
        this.min.power = 0.01;
        this.max.power = 0.99;
    ...
    TTestComponent.prototype.inputChanged = function (event) {
        var key = event.target.name;
        if (key != 'alpha' && key != 'power' && key != 'output') {
            var value_1 = event.target.value;
            if (value_1 < this.min[key]) {
                this.min[key] = value_1;
            }
            else if (value_1 > this.max[key]) {
                this.max[key] = value_1;
            }
            setTimeout(function () {
                event.target.value = value_1;
            }, 1);
        }
    };
...
module.exports = "<div class=\"overview\">\n  <button type=\"button\" class=\"btn btn-secondary\" (click)=\"toggleHelp()\">\n    Overview <i class=\"fa fa-question-circle\"></i>\n  </button>\n</div>\n<div class=\"form-group\">\n  <label>\n    Output\n    <select class=\"form-control\" name=\"output\"\n            [(ngModel)]=\"round.output\" (change)=\"inputChanged($event)\">\n      <option value=\"n\">Sample size</option>\n      <option value=\"power\">Power</option>\n      <option value=\"delta\">Detectable alternative</option>\n    </select>\n  </label>\n</div>\n<div class=\"slider-group\">\n  <div class=\"label\">Type I Error (&alpha;)</div>\n  <div class=\"inputs row\">\n    <div class=\"col-sm-9\">\n      <div class=\"slider\">\n        <div class=\"min\">{{floor(min.alpha)}}</div>\n        <input name=\"alpha\" type=\"range\" step=\"0.01\"\n               min=\"{{min.alpha}}\" max=\"{{max.alpha}}\"\n               [(ngModel)]=\"round.alpha\" (change)=\"inputChanged($event)\" />\n        <div class=\"max\">{{ceil(max.alpha)}}</div>\n      </div>\n    </div>\n    <div class=\"col-sm-3\">\n      <div class=\"number\">\n        <input name=\"alpha\" type=\"number\" step=\"0.01\"\n               min=\"{{min.alpha}}\" max=\"{{max.alpha}}\"\n               [(ngModel)]=\"round.alpha\" (change)=\"inputChanged($event)\" />\n      </div>\n    </div>\n  </div>\n</div>\n<div class=\"slider-group\">\n  <div class=\"label row\">\n    <div class=\"col-sm\">\n      Std. deviation (&sigma;)\n    </div>\n    <div class=\"col-sm form-check\">\n      <label class=\"form-check-label\">\n        <input name=\"show-alternates\" type=\"checkbox\"\n          class=\"form-check-input\"\n          [(ngModel)]=\"round.showAlternates\" />\n        Alternates\n      </label>\n    </div>\n  </div>\n  <div class=\"inputs row\">\n    <div class=\"col-sm-9\">\n      <div class=\"slider\">\n        <div class=\"min\">{{min.sigma}}</div>\n        <input name=\"sigma\" type=\"range\" step=\"0.1\"\n               min=\"{{min.sigma}}\" max=\"{{max.sigma}}\"\n               [(ngModel)]=\"round.sigma\" (change)=\"inputChanged($event)\" />\n        <div class=\"max\">{{max.sigma}}</div>\n      </div>\n    </div>\n    <div class=\"col-sm-3\">\n      <div class=\"number\">\n        <input name=\"sigma\" type=\"number\" step=\"0.1\" min=\"1\"\n               [(ngModel)]=\"round.sigma\" (change)=\"inputChanged($event)\" />\n      </div>\n    </div>\n  </div>\n</div>\n<div class=\"slider-group\" [class.output]=\"round.output == 'power'\">\n  <div class=\"label\">\n    Power\n    <span *ngIf=\"round.output == 'power'\">(Output)</span>\n  </div>\n  <div class=\"inputs row\">\n    <div class=\"col-sm-9\">\n      <div class=\"slider\">\n        <div class=\"min\">{{floor(min.power)}}</div>\n        <input name=\"power\" type=\"range\" step=\"0.01\"\n               min=\"{{min.power}}\" max=\"{{max.power}}\"\n               [disabled]=\"round.output == 'power'\"\n               [(ngModel)]=\"round.power\" (change)=\"inputChanged($event)\" />\n        <div class=\"max\">{{ceil(max.power)}}</div>\n      </div>\n    </div>\n    <div class=\"col-sm-3\">\n      <div class=\"number\">\n        <input name=\"power\" type=\"number\" step=\"0.01\"\n               min=\"{{min.power}}\" max=\"{{max.power}}\"\n               [disabled]=\"round.output == 'power'\"\n               [(ngModel)]=\"round.power\" (change)=\"inputChanged($event)\" />\n      </div>\n    </div>\n  </div>\n</div>\n<div class=\"slider-group\" [class.output]=\"round.output == 'delta'\">\n  <div class=\"label\">\n    Difference in population means (&delta;)\n    <span *ngIf=\"round.output == 'delta'\">(Output)</span>\n  </div>\n  <div class=\"inputs row\">\n    <div class=\"col-sm-9\">\n      <div class=\"slider\">\n        <div class=\"min\">{{min.delta}}</div>\n        <input name=\"delta\" type=\"range\" step=\"0.1\"\n               min=\"{{min.delta}}\" max=\"{{max.delta}}\"\n               [disabled]=\"round.output == 'delta'\"\n               [(ngModel)]=\"round.delta\" (change)=\"inputChanged($event)\" />\n        <div class=\"max\">{{max.delta}}</div>\n      </div>\n    </div>\n    <div class=\"col-sm-3\">\n      <div class=\"number\">\n        <input name=\"delta\" type=\"number\" step=\"0.1\" min=\"1\"\n               [disabled]=\"round.output == 'delta'\"\n               [(ngModel)]=\"round.delta\" (change)=\"inputChanged($event)\" />\n      </div>\n    </div>\n  </div>\n</div>\n<div class=\"slider-group\" [class.output]=\"round.output == 'n'\">\n  <div class=\"label\">\n    Sample size\n    <span *ngIf=\"round.output == 'n'\">(Output)</span>\n  </div>\n  <div class=\"inputs row\">\n    <div class=\"col-sm-9\">\n      <div class=\"slider\">\n        <div class=\"min\">{{min.n}}</div>\n        <input name=\"n\" type=\"range\" step=\"1\"\n               min=\"{{min.n}}\" max=\"{{max.n}}\"\n               [disabled]=\"round.output == 'n'\"\n               [(ngModel)]=\"round.n\" (change)=\"inputChanged($event)\" />\n        <div class=\"max\">{{max.n}}</div>\n      </div>\n    </div>\n    <div class=\"col-sm-3\">\n      <div class=\"number\">\n        <input name=\"n\" type=\"number\" step=\"1\" min=\"1\"\n               [disabled]=\"round.output == 'n'\"\n               [(ngModel)]=\"round.n\" (change)=\"inputChanged($event)\" />\n      </div>\n    </div>\n  </div>\n</div>\n"
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return TTest; });
/* unused harmony export TTestRanges */
...
var TTestSet = (function () {
    ...
    TTestSet.prototype.calcRanges = function () {
        var n, power, delta, pSpace, indices;
        var deltaMax = [2.5 * this.model.sigma, this.model.delta + (this.model.sigma / 2)].sort()[1];
        switch (this.model.output) {
            case "n":
                n = new __WEBPACK_IMPORTED_MODULE_3__range__["a" /* Range */](this.model.n * 0.5, this.model.n * 1.5);
                ...
                break;
            case "power":
                power = new __WEBPACK_IMPORTED_MODULE_3__range__["a" /* Range */](0, 1.1);
                ...
                break;
            case "delta":
                delta = new __WEBPACK_IMPORTED_MODULE_3__range__["a" /* Range */](this.model.delta * 0.5, this.model.delta * 1.5);
