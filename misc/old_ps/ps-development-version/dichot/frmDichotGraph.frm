...
Begin VB.Form frmDichotGraph 
   ...
   Begin VtChartLib.VtChart VtChart 
      ...
      _ExtentX        =   15055
      _ExtentY        =   7223
      _0              =   $"frmDichotGraph.frx":0000
      _1              =   $"frmDichotGraph.frx":0409
      _2              =   $"frmDichotGraph.frx":0812
      _3              =   $"frmDichotGraph.frx":0C1B
      _4              =   $"frmDichotGraph.frx":1024
      _5              =   $"frmDichotGraph.frx":142D
      _6              =   $"frmDichotGraph.frx":1836
      _7              =   $"frmDichotGraph.frx":1C3F
      _8              =   $"frmDichotGraph.frx":2048
      _9              =   $"frmDichotGraph.frx":2451
      _10             =   $"frmDichotGraph.frx":285A
      _11             =   $"frmDichotGraph.frx":2C63
      _12             =   $"frmDichotGraph.frx":306C
      _13             =   $"frmDichotGraph.frx":3475
      _count          =   14
      _ver            =   2
   End
   ...
   End
End
Attribute VB_Name = "frmDichotGraph"
...
'
    ...
    Call write_graph_log(Me, VtChart, "alpha=" + Format(ALPHA) + _
    " power=" + Format(POWER) + " p0=" + Format(P0) + " p1=" + Format(P1) + _
    " n=" + Format(N) + " m=" + Format(M) + " r=" + Format(r) + " psi=" + _
    Format(PSI) + " phi=" + Format(PHI) + _
    vbCrLf + _
...
'
    If OnYAxis = 1 Then
        Me.lblgraph(0).Caption = "Sample size graphs for dichotomous outcomes"
        Me.lblgraph(0).WhatsThisHelpID = 358
    ElseIf OnYAxis = 2 Then
        Me.lblgraph(0).Caption = "Power graphs for dichotomous outcomes"
        Me.lblgraph(0).WhatsThisHelpID = 356
...
'    Call CheckNumeric(frmDichotGraph.plotAtValue)
End Sub

Private Sub xHigh_LostFocus()
    Call CheckNumeric(frmDichotGraph.xHigh)
End Sub

Private Sub xLow_LostFocus()
    Call CheckNumeric(frmDichotGraph.xLow)
End Sub

Private Sub yHigh_LostFocus()
    Call CheckNumeric(frmDichotGraph.yHigh)
End Sub

Private Sub yLow_LostFocus()
    Call CheckNumeric(frmDichotGraph.yLow)
End Sub
...
'        End If
'        .Footnote.Text = "alpha=" + Format(ALPHA) + " power=" + Format(POWER) + " n=" + Format(N) + " p0=" + Format(P0) + " p1=" + Format(P1) + " m=" + Format(M) + " r=" + Format(r) + " phi=" + Format(PHI) + " psi=" + Format(PSI) + ", " + frmMain.cboDichotMatched + ", " + frmMain.cboDichotCaseControl
...
Private Sub enable_plotchange()
    ...
    ElseIf cboXaxisContent = constODDSRATIO Then
        DichotPsi.Enabled = False
    ElseIf cboXaxisContent = constXEVENTRATE Then
        DichotP1.Enabled = False
    ElseIf cboXaxisContent = constRR Then
        DichotR.Enabled = False
    ElseIf cboXaxisContent = constXP1 Then
        DichotP1.Enabled = False
    End If
